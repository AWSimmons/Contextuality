...
\makecell{ABK Triangle-Free\\Graphs} & $n-c\sqrt{n\log n}$ & $c\sqrt{n\log n}$  & $1-O\left(\frac{\log n}{n}\right) $&\ding{55}\\\hline
\makecell{Disjoint Graph Union of \\  rotated $E_8$ root systems} &$\leq 22$& $\frac{n}{15}$& $0.11\dot{6}$&\ding{51} \\ \hline
\end{tabular}
\end{center}
\caption{A table comparing the graph constructions in this paper. The $E_8$ root system forms a KS proof using 120 rays and 2025 contexts, and the quantities related to it were calculated using a proof by exhaustion.}
\end{figure}
