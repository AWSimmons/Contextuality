...
\begin{equation}
\oint_{SU(d)\times S_\mathbb{C}^{d-1}} \mathbbm{1}_{g.z\in A_{t_1,t_2}} \sum_i f_\ket{\psi_i}(z) \dif g\dif z.
\end{equation}
...
\int_{SU(d)} h(g,p,\epsilon) \dif g  &= \sum_i\int_{S_\mathbb{C}^{d-1}}f^\epsilon_\ket{\psi_i}(z)  \int_{SU(d)} \mathbbm{1}_{g.z\in A_{t_1,t_2}} \dif g \dif z \label{eqn:1} \\
 &= p(t_1,t_2)\sum_i\int_{S_\mathbb{C}^{d-1}}f^\epsilon_\ket{\psi_i}(z)  \dif z \label{eqn:2} \\
