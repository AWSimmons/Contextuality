...
\makecell{Disjoint Graph Union of \\ small KS Graphs} &\emph{e.g.} $\frac{7n}{24}$&\emph{e.g.} $\frac{5n}{24}$& $\geq\frac{1}{12}$&\ding{51} \\ \hline
\end{tabular}
\end{center}
\caption{A table comparing the graph constructions in this paper. The quantities for the entry ``Disjoint Graph Union of small KS Graphs'' were calculated for multiple disjoint copies of the Peres-Mermin magic square \cite{Pere1991} of the Bell-Kochen-Specker theorem with 24 rays and 24 contexts, using a proof by exhaustion.}
\end{figure}
